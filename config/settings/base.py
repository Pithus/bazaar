...
ADMINS = [("""Esther""", "esther@example.com")]
...
ELASTICSEARCH_PASSWORD = 'ozzejav8D749Dp4ADrB2f27ETALFigug6XV'
...
ELASTICSEARCH_SSDEEP_MANIFEST_INDEX = 'ssdeep_manifest'
